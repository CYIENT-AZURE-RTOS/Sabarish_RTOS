...
int main(void)
{
  ...
  MX_RTC_Init();
  /* USER CODE BEGIN 2 */
//  ISM330DHCX_RegisterBusIO(&pobj, &pio);
//  ISM330DHCX_Init(&pobj);
//  ISM330DHCX_ReadID(&pobj,id);
...
//    if(ISM330DHCX_ReadID(&pobj, &ISM330DHCX_Id) != ISM330DHCX_OK)
//    {
//      __BKPT(0);
//    }
//    else
...
//     HAL_UART_Transmit(&huart1, tx_buf, 6, 100);
//    }
...
//    if(ISM330DHCX_ACC_GetOutputDataRate(&pobj, &ISM330DHCX_ACCL_Odr) != ISM330DHCX_OK)
//    {
//      __BKPT(0);
//    }
//
//    if(ISM330DHCX_GYRO_GetOutputDataRate(&pobj, &ISM330DHCX_GYRO_Odr) != ISM330DHCX_OK)
//    {
//      __BKPT(0);
//    }
...
//    do
//    {
//      HTS221_HUM_Get_DRDY_Status(&pobj, &ISM330DHCX_Status);
//    }while(ISM330DHCX_Status != 1);
//
//    do
//    {
//      HTS221_TEMP_Get_DRDY_Status(&pobj, &ISM330DHCX_Status);
//    }while(ISM330DHCX_Status != 1);
